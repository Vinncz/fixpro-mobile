...
struct OnboardingSwiftUIView: View {
    ...
    @Bindable var viewModel: OnboardingSwiftUIViewModel
...
extension OnboardingSwiftUIView {
...
#Preview {
    @Previewable var viewModel = OnboardingSwiftUIViewModel()
    OnboardingSwiftUIView(viewModel: viewModel)
}
