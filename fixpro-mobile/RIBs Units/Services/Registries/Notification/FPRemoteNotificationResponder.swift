...
struct FPNotificationDigest: Identifiable, Hashable {
    
    
    /// Uniquely identifies one notification from other.
    var id: String
...
struct FPRemoteNotificationActionable: Codable, Hashable {
    
    
    enum Genus: String, Codable, Hashable {
        case SEGUE
